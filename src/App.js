...
class App extends Component {
    ...
    state = {
        dishes: [
            ...
            {id: 2, name: 'Hotdog', price: 90, amount: 0, total: 0},
            {id: 3, name: 'Cola', price: 20, amount: 0, total: 0},
            {id: 4, name: 'Coffee', price: 50, amount: 0, total: 0},
            {id: 5, name: 'Fries', price: 40, amount: 0, total: 0},
            {id: 6, name: 'Tea', price: 15, amount: 0, total: 0}
        ]
    }
        ...
        return (
            <div className="App container row">
                ...
                <OrderForm sum={this.getTotal()}>
                    ...
                    {this.state.dishes.map(item => <OrderDish
                        key={item.id}
                        name={item.name}
                        total={item.total}
                        amount={item.amount}
